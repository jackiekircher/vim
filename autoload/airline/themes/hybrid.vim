...
function! airline#themes#hybrid#refresh()
    ...
    let s:N3 = airline#themes#get_highlight2(['Text', 'fg'], ['StatusLine', 'bg'], 'bold')
    let g:airline#themes#hybrid#palette.normal = airline#themes#generate_color_map(s:N1, s:N2, s:N3)

    let modified_group = airline#themes#get_highlight2(['Text', 'fg'], ['CursorLine', 'bg'], 'bold')
    let g:airline#themes#hybrid#palette.normal_modified = {
                \ 'airline_c': airline#themes#get_highlight2(['Text', 'fg'], ['CursorLine', 'bg'], 'bold')
                \ }
    ...
    let s:I1 = airline#themes#get_highlight('SpellLocal')
    let s:I2 = s:N2
    let s:I3 = s:N3
    ...
    let s:R1 = airline#themes#get_highlight2(['Text', 'fg'], ['SpellRare', 'bg'], 'bold')
    let s:R2 = s:N2
    let s:R3 = s:N3
    ...
    let s:V1 = airline#themes#get_highlight('DiffChange')
    let s:V2 = s:N2
    let s:V3 = s:N3
