...
function! RunProcessing()
    ...
    if has("macunix") && exists("g:use_processing_applescript")
        ...
        silent execute "!bash -lc prun &"
    endif " has("macunix")...

endfunction "RunProcessing

function! RunProcessingWithOutput()
  execute "!bash -lc prun"
endfunction

map <Leader>p :call RunProcessing()<CR>
map <Leader>P :call RunProcessingWithOutput()<CR>
